// 다우 Work 물량 CSV 가져오기 — 업로드 → AI 구조화 미리보기 → 검수 후 반영
  ...
  return (
    <main className="mx-auto max-w-6xl p-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold">⬆ 물량 CSV 가져오기 <span className="text-sm font-normal text-slate-400">(다우 Work 내보내기)</span></h1>
      ...
      <div className="mt-3 rounded-xl bg-blue-50 p-4 text-sm leading-relaxed text-blue-800">
        <b>사용 순서</b><br />
        1) 다우 Work에서 물량 목록을 CSV로 내보내 업로드 → AI(gpt-5.6)가 메모·시간 정보를 구조화해 미리보기를 만듭니다.<br />
