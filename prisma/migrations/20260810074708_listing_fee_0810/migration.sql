...
INSERT INTO "new_Listing" ("brand", "category", "center", "cons", "createdAt", "deletedAt", "externalId", "extraPay", "holidays", "id", "incomeMax", "incomeMin", "initialCapitalMin", "internalMemo", "introMd", "isActive", "loadType", "numberPlates", "payStructure", "physicalLoad", "pros", "region", "reviewNote", "shift", "slotCount", "startTime", "sunTopAvailable", "unloadMethod", "updatedAt", "vehicleRequirement", "workDays", "workHours") SELECT "brand", "category", "center", "cons", "createdAt", "deletedAt", "externalId", "extraPay", "holidays", "id", "incomeMax", "incomeMin", "initialCapitalMin", "internalMemo", "introMd", "isActive", "loadType", "numberPlates", "payStructure", "physicalLoad", "pros", "region", "reviewNote", "shift", "slotCount", "startTime", "sunTopAvailable", "unloadMethod", "updatedAt", "vehicleRequirement", "workDays", "workHours" FROM "Listing";
DROP TABLE "Listing";
