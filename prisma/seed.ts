...
const listings = [
  {
    ...
    initialCapitalMin: 500, pros: "고정 코스로 안정적, 주간 근무, 초보 적응 용이",
  ...
  },
  {
    ...
    initialCapitalMin: 500, pros: "체력 부담 낮은 롤테이너 중심 코스, 안정적 물량",
  ...
  },
  {
    ...
    initialCapitalMin: 1000, pros: "편의점 고정 코스로 매우 안정적, 야간 수당 반영 수입",
  ...
  },
  {
    ...
    initialCapitalMin: 800, pros: "안정적 편의점 물량, 법인임대넘버로 초기 부담 완화 가능",
  ...
  },
  {
    ...
    initialCapitalMin: 3000, pros: "고수입 가능, 허브 간 간선으로 배송지 단순",
  ...
  },
  {
    ...
    initialCapitalMin: 2000, pros: "식자재 고정 거래처, 높은 수입",
  ...
  },
  {
    ...
    loadType: "박스", numberPlates: "개별,법인임대", vehicleRequirement: "1톤 냉탑",
    initialCapitalMin: 700, pros: "매출제로 성실도에 따라 고수입, 법인임대 진입 가능",
  ...
  },
  {
    ...
    initialCapitalMin: 5000, pros: "최상위 수입 구간, 운행 위주 업무",
